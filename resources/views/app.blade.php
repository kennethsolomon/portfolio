...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body background="{{url('bg.jpg')}}" class="min-h-screen bg-repeat md:bg-no-repeat md:bg-cover print:bg-transparent dark:bg-zinc-900 relative">
    ...
    @inertia
    <footer class="mt-12 mb-6 w-full flex flex-col items-center justify-center px-4 print:hidden absolute bottom-0">
